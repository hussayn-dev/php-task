...
//handleRequest('/api/get_capsules', ActionEnum::GET->name, function () use ($capsuleController) {
//      $capsuleController->getCapsules();
//});
//
//$serial = "";
//handleRequest('/api/get_capsules/'.  $serial, ActionEnum::GET->name, function () use ($capsuleController) {
//    global $serial;
//    $capsuleController->getOneCapsule($serial);
//});